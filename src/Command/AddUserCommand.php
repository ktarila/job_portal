...
class AddUserCommand extends Command
{
    ...
    {
        if (null !== $input->getArgument('email') && null !== $input->getArgument('password') && null !== $input->getArgument('fullname')) {
            return;
        }
        ...
        if (null !== $fullname) {
            $this->io->text(' > <info>Fullname</info>: ' . $fullname);
        } else {
    ...
    private function validateUserData($email, $plainPassword, $fullname)
    {
